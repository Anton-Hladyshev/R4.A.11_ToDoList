...
class Task(
    ...
    override fun editTitle(newTitle: String) {
        title = newTitle
    }

    override fun editDescription(newDescr: String) {
    ...
    override fun changeEndTime(newEndTime: Date) {
        endTime = newEndTime
    }

    override fun changeEndDate(newEndDate: Date) {
        endDate = newEndDate
    }
}